  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('../img/details/weight.png')} style={styles.img} />
        ...
        <View style={styles.details}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            การยกน้ำหนักช่วยเสริมสร้างกล้ามเนื้อและเพิ่มอัตราการเผาผลาญแคลอรี่ในระยะหลัง.
        ...
        <View style={styles.cal}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            การยกน้ำหนักหนักๆ 30 นาทีถึง 1 ชั่วโมง จะเผาผลาญประมาณ 200-400 แคลอรี่ต่อชั่วโมง.
