  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('../img/details/dance.png')} style={styles.img} />
        ...
        <View style={styles.details}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            การเต้นระบายคลื่นเป็นท่าออกกำลังกายที่สนุกสนานและช่วยเผาผลาญแคลอรี่.
        ...
        <View style={styles.cal}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            การเต้นแดนซ์หน่วยละ 30 นาทีถึง 1 ชั่วโมง จะเผาผลาญประมาณ 200-600 แคลอรี่ต่อชั่วโมง.
