  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('../img/details/run.png')} style={styles.img} />
        ...
        <View style={styles.details}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            วิ่งเป็นการออกกำลังกายที่ดีทั้งหมด มันเสริมสร้างความแข็งแรงของร่างกายและเผาผลาญแคลอรี่อย่างมาก.
        ...
        <View style={styles.cal}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            การวิ่งด้วยความเร็วปานกลางจะเผาผลาญประมาณ 300-400 แคลอรี่ต่อชั่วโมงต่อนานาประเภทของร่างกาย.
