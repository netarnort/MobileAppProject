  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('../img/details/robic.png')} style={styles.img} />

        <View style={styles.details}>

          <Text style={[styles.customText, { marginTop: 5 }]}>

            <Text style={styles.boldText}>รายละเอียด : </Text> การออกกำลังกายแบบแอโรบิคส์ช่วยเสริมสร้างความแข็งแรงและเผาผลาญแคลอรี่.
        ...
        <View style={styles.cal}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            <Text style={styles.boldText}>การเผาผลาญแคลอรี่ : </Text>
             การทำแอโรบิคส์หน่วยละ 30 นาทีถึง 1 ชั่วโมง จะเผาผลาญประมาณ 300-500 แคลอรี่ต่อชั่วโมง.
