  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('../img/details/yoga.png')} style={styles.img} />
        ...
        <View style={styles.details}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            โยคะเสริมสร้างความยืดหยุ่นและลดความเครียด มันไม่เผาผลาญแคลอรี่เยอะนัก แต่เป็นท่าที่ดีสำหรับสุขภาพจิต.
        ...
        <View style={styles.cal}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            การทำโยคะจะเผาผลาญประมาณ 100-200 แคลอรี่ต่อชั่วโมง.
