  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('../img/details/cycle.png')} style={styles.img} />
        ...
        <View style={styles.details}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            <Text style={styles.boldText}>รายละเอียด : </Text> 
             การขี่จักรยานเป็นท่าออกกำลังกายที่สนุกสนานและดีต่อระบบหัวใจและประสาท.
        ...
        <View style={styles.cal}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            <Text style={styles.boldText}>การเผาผลาญแคลอรี่ : </Text> 
             การขี่จักรยานหน่วยละ 30 นาทีถึง 1 ชั่วโมง จะเผาผลาญประมาณ 250-600 แคลอรี่ขึ้นอยู่กับความเร็ว.
