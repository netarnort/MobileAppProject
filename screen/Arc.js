  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <Image source={require('../img/details/arc.png')} style={styles.img} />

        <View style={styles.details}>

          <Text style={[styles.customText, { marginTop: 5 }]}>

            <Text style={styles.boldText}>รายละเอียด : </Text> การยิงธนูเป็นท่าออกกำลังกายที่เพิ่มความตั้งใจและความสมาธิ.
        ...
        <View style={styles.cal}>
          ...
          <Text style={[styles.customText, { marginTop: 5 }]}>
            ...
            <Text style={styles.boldText}>การเผาผลาญแคลอรี่ : </Text> การยิงธนูจะเผาผลาญประมาณ 100-250 แคลอรี่ต่อชั่วโมง.
